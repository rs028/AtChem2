...
<<<<<<< HEAD
  ./build/build_atchem2.sh --mechanism=$mechanism_file --shared_lib=$TESTS_DIR/$test/configuration/include --configuration=$TESTS_DIR/$test/configuration --mcm=v3.3.1 &> /dev/null
=======
...
<<<<<<< HEAD
  ./atchem2 --output=$TESTS_DIR/$test/output --shared_lib=$TESTS_DIR/$test/configuration/include --configuration=$TESTS_DIR/$test/configuration --constraints=$TESTS_DIR/$test/constraints > $TESTS_DIR/$test/$test.out 2>&1
=======
